...
from user.views import SignUpRegistrationCreateView, Skillview
from django.conf import settings
from django.conf.urls.static import static

urlpatterns = [
    path("admin/", admin.site.urls),
    path("", user_views.subscribe, name="technopulse_home"),
    path(
        "signupregistration/",
        SignUpRegistrationCreateView.as_view(),
        name="signupregistration",
    ),
    path("skill/", Skillview.as_view(), name="skill"),
    path("", include("challenges.urls", namespace="cha")),
